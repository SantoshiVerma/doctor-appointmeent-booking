    ...
    <div className=' min-h-screen bg-white border-r '>
      ...
      }
      {
        dToken && <ul className='text-[#515151]'>
          ...
          <NavLink className={({isActive})=>`flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} to ={'/doctor-dashbord'}>
            <img src ={assets.home_icon} alt =""/>
            <p>Dashbord</p>
          </NavLink>
